...
| P1 | Offene Posten (Rücklastschriften-Übersicht) | Deployed |
| P1 | Kursausfall-Benachrichtigung | Deployed |
| P1 | Admin-Hinweis auf neue Buchungen | Deployed |
| P1 | Kunden-Dashboard nach dem Login | Deployed |
| P0 (vor Start) | Rechnungen stornieren und gutschreiben | Deployed |
| P0 (vor Start) | Lastschriftlauf vor dem Bankupload korrigieren | Deployed |
| P1 | Buchungen nach Status filtern und stapelweise bearbeiten | Deployed |
| P1 | Admin auch als Lehrer eintragbar | Deployed |
| P1 | Preise bei der Kursbuchung | Deployed |
| P1 | Rechtssichere Buchungsbestätigung | Deployed |
| P1 | Englische Sprachvariante für den Kundenbereich | Deployed |
...
| P0 (vor Start) | Eine Probestunde je Kunde | Deployed |
| P1 | Veranstaltungsprogramm (Eventarten, Übersicht, Eventseite) | Deployed |
| P1 | Event-Serien (regelmäßige Veranstaltungen) | Deployed |
| P1 | Bilder & Videos für Events | Deployed |
| P1 | Ticketarten, Pässe & Einheiten | Deployed |
...
| P1 | Gasttänzer-Programm (Rollenbalance ausgleichen) | Deployed |
| P0 (vor Start) | Bankupload bestätigen, bevor die Rechnungen entstehen | Deployed |
| P1 | Kursbeschreibung und Verlinkung aus dem Stundenplan | Deployed |
